...
public class StringUtils {
	...
	//private static final HashMap<String, Character> htmlDecodeChars = new HashMap<>();
    ...
    {  
        ...
        for(Map.Entry<Character, String> entry : htmlEncodeChars.entrySet())
        {
        	...
        	Character replacement = entry.getKey();
        	htmlDecodeChars.put(regex, replacement);
        }*/
    }
    ...
    {
        return decode(source, htmlEncodeChars);
    }
	
	private static String decode(String source, HashMap<Character, String> encodingTable)
	{
		if (null == source)
        {
            return null;
        ...
        for(Map.Entry<Character, String> entry : encodingTable.entrySet())
        {
        	String regex = entry.getValue();
        	Character replacement = entry.getKey();
        	source = source.replaceAll(regex, replacement.toString());
        }
		return source;
	}
